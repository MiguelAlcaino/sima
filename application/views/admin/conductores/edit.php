...
<div class="block">
    ...
    <?php if (validation_errors()){ ?>
        ...
        <?php } ?>
      <form method="post" action="<?php echo site_url('conductores/update/'.$data[0]['id'])?>" enctype="multipart/form-data">
                ...
                <div style="float:left; width:450px">
                  ...
                  <div class="ui-widget">
                    ...
                    <p><label>Apellido</label><br /> <input value="<?php echo $data[0]['apellido']?>" type="text" name="apellido" size="55" class="text" ></p>
                    
                    <p><label>Patente asociada</label><br /> <input value="<?php echo $data[0]['patente_asociada']?>" type="text" name="patente_asociada" size="55" class="text" ></p>
                    
                    <p><label>RUT</label><br /> <input value="<?php echo $data[0]['rut']?>" type="text" name="rut" size="55" class="text" ></p>
                    
                    <p><label>Fecha de nacimiento</label><br /> <input value="<?php echo $data[0]['fecha_nacimiento']?>" id="fecha_nacimiento" type="text" name="fecha_nacimiento" size="55" class="text" ></p>
