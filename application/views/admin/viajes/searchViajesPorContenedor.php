<div class="block">
    ...
    <div class="block_head">
        ...
        <h2>Viajes por número de contenedor</h2>
        ...
        <ul>
            ...
            <li>Contenedor: <input type="text" name="numero_contenedor" id="numero_contenedor" />
    ...
    <script type="text/javascript">
      ...
      $('#btn_search').click(function(){
        $.ajax({
            ...
            url: "<?php echo site_url("ajax/viajesPropiosYTercerosPorNumeroContenedor")?>",
