                   ...
                   <?php
					...
					foreach($data as $key){
					 ?>
                        <tr class="rows">
                        	<td></td>
                            <td><a href="#"><?php echo $key['nombre_usuario'] ?></a></td>
                            <td><?php echo $key['nick_usuario']  ?></td>
                            <td><?php echo $key['mail_usuario']  ?></td>
                            <td class="options">
                                <a href="cuentas/editar/<?php echo $key['id_usuario'] ?>" class="tip" title="Editar"><img src="public/admin/images/bedit.png" /></a>
                                <a href="cuentas/eliminar/<?php echo $key['id_usuario'] ?>" class="tip"  title="Eliminar" onclick="return delete_row()"><img src="public/admin/images/bdelete.png" /></a>
