    ...
    <div class="block_content">
        ...
        <?php } ?>
			<form method="post" action="cuentas/actualizar/" enctype="multipart/form-data">                
                ...
                <p><label>Nombre</label> <br /><input type="text" name="nombre" size="55" class="text" value="<?php echo $data[0]['nombre_usuario']?>"> </p>
                <p><label>Email</label> <br /><input type="text" name="email" size="55" class="text medium" value="<?php echo $data[0]['mail_usuario']?>"></p> 
