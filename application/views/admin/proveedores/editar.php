        ...
        <?php } ?>
			<form method="post" action="<?php echo site_url('proveedores/actualizar')?>" enctype="multipart/form-data">
                ...
                <div style="float:left; width:450px">
                    <p><label>Nombre Comercial</label><br /> <input type="text" name="nombre"  size="55" class="text" value="<?php echo $data[0]['nombre_comercial'] ?>"></p>
                ...
                <div style="float:left; width:450px; margin-left:50px">
                 	<p><label>Provincia</label><br /> <select class="styled" name="provincia"><option value=" ">- Seleccionar</option><?php 			foreach($provincias as $key){
						 ...
						 ?></select></p>
                    <p><label>Población</label><br /> <input type="text" name="poblacion" size="55" class="text" value="<?php echo $data[0]['poblacion'] ?>"></p>
                    ...
                    <p><label>Tipo Empresa</label><br /> <input type="text" name="tipo" size="55" class="text" value="<?php echo $data[0]['tipo_empresa'] ?>"></p>
