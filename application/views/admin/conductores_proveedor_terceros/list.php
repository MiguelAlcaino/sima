...
<div class="block">
    ...
    <div class="block_head">
        ...
        <h2>Conductores de terceros</h2>
        
        <ul>
          <li class="active"><?php echo anchor("conductores_proveedor_terceros", "Lista de conductores")?></li>
            <li><?php echo anchor("conductores_proveedor_terceros/nuevo", "Nuevo conductor")?></li>            
    ...
    <script type="text/javascript">
      ...
      function search_factura(q, fi, ff, t){
        $.ajax({
          ...
          type: "POST",
          dataType: "json",
          url: "<?php echo site_url('ajax/list_conductores_proveedor_terceros_ajax')?>",
            success: function(data){ 
              if(data.length > 0){
                ...
                $.each(data, function(i,item){
                  ...
                  html += '<td>';
                  html += '<a href="<?php echo site_url('conductores_proveedor_terceros/editar')?>/'+item.id+'" class="tip" title="Editar"><img src="<?php echo base_url('public/admin/images/bedit.png')?>" /></a>&nbsp;';
                  html += '<a href="<?php echo site_url('conductores_proveedor_terceros/eliminar')?>/'+item.id+'" class="tip"  title="Eliminar" onclick="return delete_row()"><img src="<?php echo base_url('public/admin/images/bdelete.png')?>" /></a>&nbsp; </td>';
